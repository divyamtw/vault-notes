...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(data.accessToken, data.safeUser);
      navigate("/home");
    } catch (err) {
      setError(
  ...
  return (
    <div className="relative min-h-screen bg-neutral-950 flex flex-col justify-center items-center overflow-hidden font-sans text-neutral-100">
      {/* Background Blurs */}
      <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-indigo-600/20 rounded-full filter blur-[100px]"></div>
      <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-fuchsia-600/20 rounded-full filter blur-[100px]"></div>

      <div className="z-10 w-full max-w-md p-8 md:p-10 bg-neutral-900/40 backdrop-blur-xl border border-neutral-800 rounded-3xl shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-400 mt-2">Enter your credentials to access your vault</p>
        </div>
